--[[
	...
	Revision: $Id: PanelScroller.lua 232 2010-03-23 23:21:50Z Kandoko $
...
LibStub("LibRevision"):Set("$URL: http://svn.norganna.org/libs/tags/5.8/Configator/PanelScroller.lua $","$Rev: 232 $","5.1.DEV.", 'auctioneer', 'libs')
