...
Revision: $Rev: 36 $
Author(s): kemayo (kemayo AT gmail DOT com)
Documentation: http://www.wowace.com/wiki/LibBabble-CreatureType-3.0
SVN: http://svn.wowace.com/wowace/trunk/LibBabble-CreatureType-3.0
Dependencies: None
License: MIT
]]
