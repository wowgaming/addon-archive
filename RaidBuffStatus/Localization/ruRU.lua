...
L["Missing or not working oRA2: "] = "Не работает/отсутствует аддон oRA2: "
L["Missing Vigilance"] = "Отсутствует Бдительность"
-- L["No"] = ""
L["No buffs needed! (Boss)"] = "Нет требуемых баффов! (Босс)"
L["No buffs needed! (Trash)"] = "Нет требуемых баффов! (Треш)"
...
L["Disable in combat"] = "Отключать в бою"
L["DPS mana"] = "Мана DPS"
...
-- L["Hide Boss R Trash"] = ""
L["Hide dashboard and skip buff checking during combat"] = "Скрывать табло и не следить за баффами во время боя"
...
L["[IMMUNE] Danielbarron FAILED TO TAUNT his target (The Lich King) with Hand of Reckoning"] = "Danielbarron FAILED TO TAUNT his target (Lich King) with Hand of Reckoning" -- Needs review
-- L["Just my buffs"] = ""
...
L["Warn using raid warning when a melee DPS dies"] = "Объявлять рейду, когда умирает мили DPS" -- Needs review
L["Warn using raid warning when a non-tank breaks Crowd Control"] = "Сообщать о снятии контроля не-танком посредством объявления рейду"
-- L["Warn using raid warning when a ranged DPS dies"] = ""
L["Warn using raid warning when a tank breaks Crowd Control"] = "Сообщать о снятии контроля танком посредством объявления рейду"
L["Warn using raid warning when a tank dies"] = "Предупреждать используя объявление рейду, когда умирает танк "
-- L["Warn using raid warning when one of your taunts fails due to resist"] = ""
L["Warn using raid warning when one of your taunts fails due to the target being immune"] = "Объявлять рейду о неудаче ваших провокаций" -- Needs review
L["Warn using raid warning when other people's taunts to your target fail"] = "Обьявлять рейду о неудачных провокациях вашей цели другими людьми"
...
L["Warn using raid warning when someone else taunts your target"] = "Обьявлять рейду о провокации вашей цели кем-либо"
...
L[" FAILED TO NINJA my boss target ("] = " FAILED TO NINJA my boss target ("
L[" FAILED TO NINJA my target ("] = " FAILED TO NINJA my target ("
L[" FAILED TO TAUNT his boss target ("] = " FAILED TO TAUNT his boss target (" -- Needs review
L[" FAILED TO TAUNT his target ("] = " FAILED TO TAUNT his target (" -- Needs review
L[" FAILED TO TAUNT my boss target ("] = " FAILED TO TAUNT my boss target (" -- Needs review
L[" FAILED TO TAUNT my target ("] = " FAILED TO TAUNT my target (" -- Needs review
L[" ninjaed my boss target ("] = " ninjaed my boss target ("
L[" ninjaed my target ("] = " ninjaed my target ("
L["NON-TANK "] = "NON-TANK "
L[" taunted my boss mob ("] = " taunted my boss mob ("
L[" taunted my boss target ("] = " taunted my boss target ("
L[" taunted my mob ("] = " taunted my mob ("
L[" taunted my target ("] = " taunted my target ("
L[") with "] = ") с "
