...
L["Missing or not working oRA2: "] = true
...
L["%s has a newer version of RBS (%s) than you (%s)"] = true
...
L["[IMMUNE] Danielbarron FAILED TO TAUNT his target (The Lich King) with Hand of Reckoning"] = true
...
L["[RESIST] Danielbarron FAILED TO TAUNT his target (The Lich King) with Hand of Reckoning"] = true
...
L[" FAILED TO NINJA my boss target ("] = true
L[" FAILED TO NINJA my target ("] = true
L[" FAILED TO TAUNT his boss target ("] = true
L[" FAILED TO TAUNT his target ("] = true
L[" FAILED TO TAUNT my boss target ("] = true
L[" FAILED TO TAUNT my target ("] = true
L[" ninjaed my boss target ("] = true
L[" ninjaed my target ("] = true
L["NON-TANK "] = true
L[" taunted my boss mob ("] = true
L[" taunted my boss target ("] = true
L[" taunted my mob ("] = true
L[" taunted my target ("] = true
L[") with "] = true
